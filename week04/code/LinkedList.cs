...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (current != null)
        {
            ...
            {
                Console.WriteLine($"current.Data matches value: -- {current.Data}");

                /// If the value is found & it's the head, run the RemoveHead function
                if (current == _head)
                {
                    RemoveHead();
                    current = null;
                }
                /// If the value is found & it's the tail, run the RemoveTail function
